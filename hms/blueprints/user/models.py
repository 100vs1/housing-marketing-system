...
from hms.blueprints.billing.models.credit_card import CreditCard
...
from hms.blueprints.bet.models.bet import Bet
from hms.blueprints.blog.models import Post
...
class User(UserMixin, ResourceMixin, db.Model):
    ...
    def initialize_password_reset(cls, identity):
        ...
        from hms.blueprints.user.tasks import (
