...
from hms.blueprints.admin.models import Dashboard
from hms.blueprints.user.decorators import role_required
from hms.blueprints.billing.decorators import handle_stripe_exceptions
from hms.blueprints.billing.models.coupon import Coupon
from hms.blueprints.billing.models.subscription import Subscription
from hms.blueprints.billing.models.invoice import Invoice
from hms.blueprints.user.models import User
from hms.blueprints.admin.forms import (
    SearchForm,
    BulkDeleteForm,
    UserForm,
...
def users_bulk_delete():
    ...
    if form.validate_on_submit():
        ...
        from hms.blueprints.billing.tasks import delete_users
...
def coupons_bulk_delete():
    ...
    if form.validate_on_submit():
        ...
        # Prevent circular imports.
        from hms.blueprints.billing.tasks import delete_coupons
