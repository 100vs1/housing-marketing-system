...
class HsholdStats(db.Model):
    ...
    @classmethod
    def find_by_filter_for_map(cls, sid_cds, sgg_cds, rsdnc_clsftn_cds, fmly_num_cds, room_num_cds, st_year, ed_yer):
        # 서브 쿼리
    ...
    @classmethod
    def find_by_filter_for_grid(cls, sid_cds, sgg_cds, rsdnc_clsftn_cds, fmly_num_cds, room_num_cds, st_year, ed_yer):
